...
class _SignupScreenState extends State<SignupScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _handleSignup() async {
    ...
    try {
      final result = await ApiService.register(name, dob, email, password);
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                Text('Fill your details below', style: TextStyle(fontSize: 18, color: Colors.white70)),
                const SizedBox(height: 60),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelStyle: TextStyle(color: Colors.white60),
                    prefixIcon: const Icon(Icons.cake, color: Colors.white60),
                    filled: true,
                    fillColor: const Color(0xFF3D2B4D).withOpacity(0.8),
                    border: OutlineInputBorder(borderRadius: BorderRadius.circular(20), borderSide: BorderSide.none),
                  ),
